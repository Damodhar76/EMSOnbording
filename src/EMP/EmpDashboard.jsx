    ...
    <div className="d-flex" style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f5f7fa, #c3cfe2)' }}>
      ...
      <div className="sidebar" style={{ width: '240px', paddingTop: '60px', backgroundColor: '#343a40', color: 'white' }}>
        <ListGroup>
          ...
          <Typography variant='h5' sx={{ backgroundColor: "rgb(162, 162, 241)", padding: '0.5rem' }}><Link to={'/NewEmployee'}>New Employee</Link></Typography>
          ...
          <Collapse in={openForms}>
            <ListGroup sx={{backgroundColor: "white"}}>
              ...
              <ListGroupItem action style={{ backgroundColor: 'white', borderColor: '#6c757d' }}>Resignation</ListGroupItem>
