      ...
      <div className="sidebar" style={{ width: '240px', paddingTop: '60px', backgroundColor: '#343a40', color: 'white' }}>
        <ListGroup>
          ...
          <Collapse in={openIncoming}>
            <ListGroup>
              <ListGroupItem action style={{ backgroundColor: '#6c757d', borderColor: '#6c757d',color:"white" }}>Accepted</ListGroupItem>
          ...
          <Collapse in={openNoC}>
            <ListGroup>
              ...
              <ListGroupItem action style={{ backgroundColor: '#6c757d', borderColor: '#6c757d',color:"white" }}>Relieving Letter & NoC</ListGroupItem>
            </ListGroup>
          </Collapse>
        </ListGroup>
      </div>
